...
public class PatientViewModel {
	...
	public PatientViewModel(int id, String name, int vaccineID, String vaccineName, int vaccineDosesRequired,
			int vaccineDosesLeft, Date firstDoseDate, Date secondDoseDate) {
